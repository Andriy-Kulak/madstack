...
- Prefer the provider-specific skills in `skills/` when the user asks for video analysis, ad teardown, or video generation.
...
- Only refer to env var names such as `GEMINI_API_KEY`, `GOOGLE_API_KEY`, and `FAL_KEY`.
